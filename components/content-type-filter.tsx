  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="border-purple-800/30 bg-gray-900">
        ...
        <DropdownMenuItem onClick={() => setContentType("Social Posts")}>Social Posts</DropdownMenuItem>
        <DropdownMenuItem onClick={() => setContentType("Video Scripts")}>Video Scripts</DropdownMenuItem>
        <DropdownMenuItem onClick={() => setContentType("Newsletters")}>Newsletters</DropdownMenuItem>
        <DropdownMenuItem onClick={() => setContentType("Podcast Scripts")}>Podcast Scripts</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  )
}
